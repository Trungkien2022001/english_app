/**
 * SQLite Database Schema for EnglishApp Mobile
 * Schema tương tự backend PostgreSQL database
 */
...
-- Local Test Sessions (offline tests)
...
CREATE INDEX IF NOT EXISTS idx_test_sessions_user ON local_test_sessions(test_session_id);
`;
